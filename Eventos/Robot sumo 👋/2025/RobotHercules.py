...
motor_izq_adelante = Pin(19, Pin.OUT)
motor_izq_atras = Pin(20, Pin.OUT)
motor_der_adelante = Pin(21, Pin.OUT)
motor_der_atras = Pin(22, Pin.OUT)

sensor_linea_izq_adelante = Pin(15, Pin.IN)
sensor_linea_der_atras = Pin(18, Pin.IN)
sensor_linea_izq_atras = Pin(16, Pin.IN)
sensor_linea_der_adelante = Pin(0, Pin.IN)
