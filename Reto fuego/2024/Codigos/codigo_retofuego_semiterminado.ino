...
// IZQUIERDO
#define echo1 A14  // echo ultrasonido #1
#define trig1 A15  // trigger ultrasonido #1

#define echo2 A2  // echo ultrasonido #2
#define trig2 A3  // trigger ultrasonido #2

#define echo3 A1  // echo ultrasonido #3
#define trig3 A0  // trigger ultrasonido #3
...
void setup() {
  ...
  ESC.attach(15);              //Pin en el que va a estar conectado el motor
  ESC.writeMicroseconds(200);  //Inicializar el motor en su estado "apagado"
...
void loop() {
  ...
  else if (DI == 1 && DD == 1 /*&& TI == 1 && TD == 1*/) {

    if (distancia1 < 18.0 && distancia2 > 18.0 && distancia3 > 18.0) {
      Derecha();
      delay(500);
    } else if (distancia3 < 18.0 && distancia1 > 18.0 && distancia2 > 18.0) {
      Izquierda();
      delay(500);
    } else if (distancia2 < 18.0 && distancia1 > 18.0 && distancia3 > 18.0) {
      Atras();
      delay(500);
      Derecha();
      delay(1000);
    } else if (distancia1 > 18.0 && distancia2 > 18.0 && distancia3 > 18.0) {
